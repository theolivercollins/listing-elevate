      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", overflow: "hidden", minHeight: 0 }}>
          ...
          >
            ...
            <div
              style={{
                // Cap to ~6 visible cards (each ~70px tall incl. gap) — past
                // that the panel scrolls instead of stretching the whole
                // modal. Oliver flagged on Hendry Creek where 20+ iterations
