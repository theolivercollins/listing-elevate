...
Last updated: 2026-05-27 (Director runtime ffmpeg + DirectorModal UX overhaul + speed-ramp removed)
...
**2026-05-27 (latest): Director runtime ffmpeg + DirectorModal UX overhaul + speed-ramp removed (PR #96, merge commit `09d7522`).** Five coupled changes that finally unstick Director Generate on prod.
