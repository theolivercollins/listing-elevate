...
| 086–092 | *(not yet documented in this table — see HANDOFF.md shipping log for details)* | Includes video library (086), show_branding preview links (087), delivery photo selection checkpoint (088), cost_events unit type widening (089), planned compute_units fix (090), operator autopilot pipeline (091/092). |
